...
export default function App() {
  ...
  return (
    <ErrorBoundary onReset={() => setViewState('form')}>
              ...
              <div className="bg-[#0A1833] border-2 border-red-500/50 rounded-3xl p-8 max-w-lg w-full text-center shadow-2xl shadow-red-950/50">
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-bold transition-all cursor-pointer"
                  >
                    입력 폼 수정하기
                  </button>
                  <button
                    onClick={() => currentUserSpecs && handleAnalyzeSpecs(currentUserSpecs)}
                    className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold transition-all shadow-lg shadow-blue-600/30 flex items-center gap-2 cursor-pointer"
                  >
